...
def generate_label_ordered_product_states_and_log_prior(discrete_prior_config):
    ...
    unnorm_label_ordered_product_state_prior_li *= (1. - (1. - allelic_copy_number_change_prior_prob) * ~np.all(label_ordered_allelic_copy_number_product_states_lij == normal_allelic_copy_number_state, axis=(1, 2)))[:, np.newaxis]
...
discrete_prior_config = DiscretePriorConfig(
    ...
    allelic_copy_number_change_prior_prob = 0.999,
...
continuous_prior_config = ContinuousPriorConfig(
    ...
    subclonal_cancer_cell_fraction_alpha = 1E-6,
    purity_a = 1.,
    purity_b = 20.,
    cr_norm_s = 0.5,
    cr_norm_scale = 2.,
