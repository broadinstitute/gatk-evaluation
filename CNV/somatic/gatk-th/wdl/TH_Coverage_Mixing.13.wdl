...
task MixPair {
    ...
    String entity_id_ = "${tumor_entity_id}-N-${100 - mixing_tumor_percentage}-T-${mixing_tumor_percentage}"
    ...
    command <<<
        ...
        class Pair:
            ...
            def mix(self, mixing_tumor_percentage, output_path):
                ...
                mix_name = f'{self.tumor_entity_id}-N-{100 - mixing_tumor_percentage}-T-{mixing_tumor_percentage}'
