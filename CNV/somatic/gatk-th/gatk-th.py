...
discrete_prior_config = DiscretePriorConfig(
    ...
    allelic_copy_number_change_prior_prob = 1E-2,
...
def main():
    ...
    modeled_segments_path = args.modeled_segments_path

    run_th(modeled_segments_path, output_prefix, output_path, global_config_vectorized, vectorize=True, show=False)
