...
def create_segments_df_for_comparison_germline_removed(segments_df):
    ...
    comparison_edit_germline_removed = comparison_edit_germline_removed[
        (comparison_edit_germline_removed[POSSIBLE_GERMLINE_COL] == "0") | (comparison_edit_germline_removed[POSSIBLE_GERMLINE_COL] == "0.") | (comparison_edit_germline_removed[POSSIBLE_GERMLINE_COL] == "0.0")]
