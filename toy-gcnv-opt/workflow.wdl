...
workflow EvaluateCNVGermlineCohortWorkflow {
    ...
    call EvaluateCalls {
        input:
            genotyped_segments_vcfs = PostprocessGermlineCNVCalls.genotyped_segments_vcf,
            truth_bed_sample_ids = truth_bed_sample_ids,
            padded_intervals = PreprocessIntervals.preprocessed_intervals,
    ...
    output {
        ...
        Float objective_value = EvaluateCalls.f1_score
    }
}
